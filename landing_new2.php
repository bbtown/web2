...
<?php
		    ...
		    echo "<div class=\"col-md-4\" style=\"height:500px\">";
			    ...
			    echo "<div style=\"height:130px;\"><strong>".$doc['ProblemDescription']."</strong></div>";
			    echo "<div style=\"height:100px;\"><small class=\"text-muted\">Tags: ".$doc['Tags']."</small><br/>";
			    echo "Influencing Factors: ".$doc['Factors']."<br/>";
			    echo "390 Likes<br/></div>";
			    echo "<div style=\"height:20px;\"> <form class=\"form-horizontal\" method=\"post\" id=\"retrieve\" action=\"retrieve_problem.php\">
