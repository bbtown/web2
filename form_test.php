                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                          <!--  <form method="get" class="form-horizontal"> -->
                                <form class="form-horizontal" action="submit_to_problems.php" method="post">
<!-- use post because it is more secure. -->
                               <!-- <div class="form-group"><label class="col-sm-2 control-label">Problem Summary<h6>This is the only required field.</h6></label>
                                 ...
                                 <div class="form-group">
                                     <label class="col-sm-2 control-label">Problem Summary<h6>This is the only required field.</h6></label>
                                        <div class="col-sm-10">
                                        <textarea class="form-control input-sm" rows="5" minlength="10" maxlength="500" name="prob_desc" required> </textarea>
...
<!--    
                                ...
                                <div class="form-group">
                                     <label class="col-sm-2 control-label">Additional Problem Information</label>
                                        <div class="col-sm-10">
                                        <textarea class="form-control input-sm" rows="5" maxlength="1500" name="prob_more"> </textarea>
                               ...
                               <!-- <div class="form-group"><label class="col-sm-2 control-label">Perspective</label>
                                ...
                                <div class="form-group">
                                     <label class="col-sm-2 control-label">Perspective</label>
                                        <div class="col-sm-10">
                                        <textarea class="form-control input-sm" rows="1" maxlength="1500" name="prob_more"> </textarea>
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label">Upload Link</label>
                                    <div class="col-sm-10"><input type="url" placeholder="http://" class="form-control" name="url"> <span class="help-block m-b-none">Have an image, video, or article that helps describe the problem?</span>
                                    </div>
                                </div>
                                <div>
